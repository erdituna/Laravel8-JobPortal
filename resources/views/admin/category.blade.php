                        ...
                        <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{route('admin_category_add')}}" type="button"
                                       class="btn btn-block btn-lg btn-info" style="width: 200px">Add Category</a>
                                        ...
                                        <table id="myTable" class="table table-bordered table-striped">
                                            ...
                                            @foreach ($datalist as $rs)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $rs->status }}</td>
                                                    <td>
                                                        <a href="{{route('admin_category_edit',['id'=> $rs->id])}}"><i class="fa fa-edit"></i></a>
                                                    </td>
